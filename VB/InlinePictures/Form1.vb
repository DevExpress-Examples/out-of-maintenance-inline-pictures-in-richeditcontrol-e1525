...
If dialog.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
    ...
    richEditControl1.Document.Images.Insert(pos, DocumentImageSource.FromFile(imageToInsert))
End If
'#End Region ' #fromfile
...
Dim images As ReadOnlyDocumentImageCollection = richEditControl1.Document.Images.Get(richEditControl1.Document.Range)
