...
Private Sub btnFromImage_Click(ByVal sender As Object, ByVal e As EventArgs) _
    Handles btnFromImage.Click
'#Region "#fromimage"
...
Private Sub btnFromFile_Click(ByVal sender As Object, ByVal e As EventArgs) _
    Handles btnFromFile.Click
'#Region "#fromfile"
Dim pos As DocumentPosition = richEditControl1.Document.CaretPosition
...
Private Sub btnFromStream_Click(ByVal sender As Object, ByVal e As EventArgs) _
    Handles btnFromStream.Click
'#Region "#fromstream"
Dim pos As DocumentPosition = richEditControl1.Document.CaretPosition
...
Private Sub btnScaleDown_Click(ByVal sender As Object, ByVal e As EventArgs) _
    Handles btnScaleDown.Click
'#Region "#scaledown"
richEditControl1.Document.Unit = DevExpress.XtraRichEdit.DocumentUnit.Millimeter
Dim images As DocumentImageCollection = _
    richEditControl1.Document.GetImages(richEditControl1.Document.Range)
...
Private Sub btnFromUri_Click(ByVal sender As Object, ByVal e As EventArgs) _
    Handles btnFromUri.Click
'#Region "#fromuri"
Dim pos As DocumentPosition = richEditControl1.Document.CaretPosition
